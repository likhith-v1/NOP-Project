...
from retinal_oct.utils.dataloader import build_dataloaders, load_config, get_class_weights, build_datasets
from retinal_oct.utils.metrics import MetricTracker, compute_metrics, run_inference
...
def train(optimizer_name: str, cfg: dict) -> MetricTracker:
    ...
    for epoch in range(1, epochs + 1):
        ...
        train_loss = train_one_epoch(
            ...
            epoch=epoch, optimizer_name=optimizer_name,
            use_hvp=is_lbm, hvp_interval=10,
        )
        ...
        if recall > best_recall:
            ...
            print(f"    ✓ Checkpoint saved (macro recall={best_recall:.4f})")
        else:
            patience_ctr += 1
